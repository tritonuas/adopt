...
class CalcRange(ot.Group):
  ...
  def setup(self):
    ...
    battery_energy_density = self.declare_input('battery_energy_density', val=(5200*14.8/1000*3600)/0.4365)
    l_over_d = self.declare_input('l_over_d', val=15)
    battery_weight = self.declare_input('battery_weight_cruise', val=436.5*4/1000*9.81)
